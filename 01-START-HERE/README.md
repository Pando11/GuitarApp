...
- **Current on World 1:** `02-spec/guitar-app-spec-AMENDMENT-17.md` (ratified World 1 = Emerald Hollow, teacher Sage, first performance ladder) — see also `docs/adr/0004-the-teacher-world-1-emerald-hollow.md` and `docs/plans/TIER-W-emerald-hollow.md`.
