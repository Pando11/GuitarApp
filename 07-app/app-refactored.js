// app.js — GuitarApp PWA shell (REFACTORED with Event-Driven State Management)
//
// Live TTS path:
...
//
// STATE MANAGEMENT:
//   Use AppStateEmitter instead of directly mutating app object.
//   Subscribe to state changes: GuitarApp.onTeacherChanged(callback)
...
(function (global) {
  ...
  const appState = {
    ...
    // Backwards compatibility: expose app object (read-only facade)
  ...
  // ============================================================================
  // REFACTORED: setCurrentTeacher() with event emission
  // ============================================================================
