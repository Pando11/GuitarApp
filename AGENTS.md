...
2. **Listening is BACK as the headline (AMENDMENT-05, 2026-08-07) — constrained form only.**
   ...
   On-device, audio never uploaded, confidence
...
8. **Chord correctness is non-negotiable
...
Backend: PocketBase (MIT, self-hosted — AMENDMENT-16, replaces Supabase), RevenueCat, Cloudflare Workers, PostHog, Sentry.
